...
noncomputable def covariant_O_Maxwell_residual (F : Fin 8 → Fin 4 → Fin 4 → ℝ) (φ_val : ℝ) (a : Fin 8) (ν : Fin 4) : ℝ :=
  covariant_div_F_O F 1 a ν - 4 * Real.pi * J_O a ν
...
theorem trivial_is_covariant_solution :
  ...
  simp only [Finset.sum_const_zero, sub_self, HQVM_lapse, grad_phi]
  constructor
